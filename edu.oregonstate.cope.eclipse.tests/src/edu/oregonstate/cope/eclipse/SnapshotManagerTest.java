...
public class SnapshotManagerTest extends PopulatedWorkspaceTest {
	...
	public void setUp() throws Exception {
		File file = new File(COPEPlugin.getVersionedLocalStorage(), "known-projects");
		file.createNewFile();
	...
	public void tearDown() throws Exception {
		File[] zipFiles = listZipFilesInDir(COPEPlugin.getVersionedLocalStorage());
	...
	public void testKnowProject() throws Exception {
		...
		assertEquals("known1\nknown2\nlibrariesTest\nknown3\n",new String(Files.readAllBytes(Paths.get(COPEPlugin.getVersionedLocalStorage().getAbsolutePath(), "known-projects"))));
	}
	...
	public void testTouchProjectInSession() throws Exception {
		...
		File fileDir = COPEPlugin.getVersionedLocalStorage();
